...
The temporal bones are overlaid by the sides of the head known as the temples where four of the cranial bones fuse. Each temple is covered by a temporal muscle. The temporal bones house the structures of the ears. The lower seven cranial nerves and the major vessels to and from the brain traverse the temporal bone.</p>`,
  ...
  Ristiluu: `<h2>Sacrum</h2><p>The sacrum situates at the upper, back part of the pelvic cavity, between the two wings of the pelvis. The sacrum (pl.: sacra or sacrums[1]), in human anatomy, is a triangular bone at the base of the spine that forms by the fusing of the sacral vertebrae (S1–S5) between ages 18 and 30.</p>`,
  Rintalasta: `<h2>Sternum</h2><p>The sternum (pl.: sternums or sterna) or breastbone is a long flat bone located in the central part of the chest. It connects to the ribs via cartilage and forms the front of the rib cage, thus helping to protect the heart, lungs, and major blood vessels from injury. Shaped roughly like a necktie, it is one of the largest and longest flat bones of the body. Its three regions are the manubrium, the body, and the xiphoid process.[1] The word sternum originates from Ancient Greek στέρνον (stérnon) 'chest'.</p>`,
  Kylkiluu: `<h2>Rib</h2><p>In vertebrate anatomy, ribs (Latin: costae) are the long curved bones which form the rib cage, part of the axial skeleton.[1] In most tetrapods, ribs surround the thoracic cavity, enabling the lungs to expand and thus facilitate breathing by expanding the thoracic cavity. They serve to protect the lungs, heart, and other vital organs of the thorax.</p>`,
